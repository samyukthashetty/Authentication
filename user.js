...
router.post('/users', authenticateToken, (req, res) => {
  ...
  router.put('/users', authenticateToken, (req, res) => {
  ...
  router.post('/userprofiles', authenticateToken, (req, res) => {
  ...
  router.get('/userprofiles/:id', authenticateToken, (req, res) => {
  ...
  router.delete('/userprofiles/:id', authenticateToken, (req, res) => {
    const userProfileId = req.params.id;
  ...
  router.put('/userprofiles/:id', authenticateToken, (req, res) => {
    const userProfileId = req.params.id;
